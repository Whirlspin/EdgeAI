            ...
            <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
                ...
                <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
                    ...
                    <Paragraph className="mt-8">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel ante fermentum, accumsan augue id, interdum ex. Nunc sed fringilla ante, ut semper justo.
                    </Paragraph>
                    ...
                    <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
                        <div className="flex sm:flex-row flex-col gap-5 w-full">
                            <form action="#" className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3 shadow-lg shadow-box-shadow border border-box-border bg-box-bg rounded-full ease-linear focus-within:bg-body focus-within:border-primary">
                                ...
                                <input type="email" placeholder="butterfly@go.com" className="w-full py-3 outline-none bg-transparent" />
                                <Button className="min-w-max text-white"><span className="hidden sm:flex relative z-[5]">Get started</span></Button>
                            </form>
                        </div>
                    </div>
                ...
                <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
                    <img src="https://images.pexels.com/photos/8107817/pexels-photo-8107817.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Purple SaaS" className="lg:absolute lg:w-full lg:h-full rounded-3xl object-cover lg:max-h-none max-h-96" />
                </div>
            </Container>
